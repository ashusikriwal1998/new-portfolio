...
export const VideoPreview = ({ children }: VideoPreviewProps) => {
  ...
  // Use specific types for the refs
  const sectionRef = useRef<HTMLOptionElement | null>(null); // Reference for the container section
  ...
  return (
    ...
    >
      <div
        ref={contentRef} // Type is now HTMLDivElement
